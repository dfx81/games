...
/** @type {string} */
const CACHE_VERSION = '1773806386|71971621423';
/** @type {string} */
const CACHE_PREFIX = 'obscura-project-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'obscura.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["obscura.html","obscura.js","obscura.offline.html","obscura.icon.png","obscura.apple-touch-icon.png","obscura.audio.worklet.js","obscura.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["obscura.wasm","obscura.pck"];
